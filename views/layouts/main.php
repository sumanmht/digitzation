...
$this->registerJsFile(Yii::$app->request->baseUrl . '/js/birthradio.js', ['depends' => [\yii\web\JqueryAsset::className()]]);
$this->registerJsFile(Yii::$app->request->baseUrl . '/js/birth.js', ['depends' => [\yii\web\JqueryAsset::className()]]);
