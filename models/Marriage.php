...
class Marriage extends \yii\db\ActiveRecord
{
    ...
    public function rules()
    {
        return [
            ...
            [['district', 'local_level', 'ward', 'g_place_of_birth', 'g_permanent_address', 'g_ctz_district', 'b_place_of_birth', 'b_permanent_address', 'b_ctz_district', 'inf1_ctz_district', 'inf2_ctz_district'], 'string', 'max' => 50],
            [['reg_no', 'g_prev_marital_status', 'b_prev_marital_status'], 'string', 'max' => 10],
            [['reg_year', 'ad_reg_year', 'marriage_year', 'ad_marriage_year', 'g_birth_year', 'ad_g_birth_year', 'g_ctz_year', 'ad_g_ctz_year', 'b_birth_year', 'ad_b_birth_year',  'b_ctz_year', 'ad_b_ctz_year',  'inf1_ctz_year', 'ad_inf1_ctz_year', 'inf2_ctz_year', 'ad_inf2_ctz_year'], 'string', 'max' => 4],
            [['reg_month', 'ad_reg_month', 'reg_day', 'ad_reg_day', 'marriage_month', 'ad_marriage_month', 'marriage_day', 'ad_marriage_day', 'g_birth_month', 'ad_g_birth_month', 'g_birth_day', 'ad_g_birth_day', 'g_ctz_month', 'ad_g_ctz_month', 'g_ctz_day', 'ad_g_ctz_day', 'b_birth_month', 'ad_b_birth_month', 'b_birth_day', 'ad_b_birth_day', 'b_ctz_month', 'ad_b_ctz_month', 'b_ctz_day', 'ad_b_ctz_day', 'inf1_ctz_month', 'ad_inf1_ctz_month', 'inf1_ctz_day', 'ad_inf1_ctz_day', 'inf2_ctz_month', 'ad_inf2_ctz_month', 'inf2_ctz_day', 'ad_inf2_ctz_day'], 'string', 'max' => 2],
            [['registrar_name', 'groom_fname', 'groom_mname', 'groom_lname', 'g_education', 'g_religion', 'g_mother_tongue', 'g_grand_fname', 'g_grand_mname', 'g_grand_lname', 'g_father_fname', 'g_father_mname', 'g_father_lname', 'bride_fname', 'bride_mname', 'bride_lname', 'b_education', 'b_religion', 'b_mother_tongue', 'b_grand_fname', 'b_grand_mname', 'b_grand_lname', 'b_father_fname', 'b_father_mname', 'b_father_lname', 'b_father_fname_eng', 'b_father_mname_eng', 'b_father_lname_eng', 'inf1_fname', 'inf1_mname', 'inf1_lname', 'inf2_fname', 'inf2_mname', 'inf2_lname', 'groom_fname_eng', 'groom_mname_eng', 'groom_lname_eng', 'bride_fname_eng', 'bride_mname_eng', 'bride_lname_eng', 'g_grand_fname_eng', 'g_grand_mname_eng', 'g_grand_lname_eng', 'g_father_fname_eng', 'g_father_mname_eng', 'g_father_lname_eng', 'b_grand_fname_eng', 'b_grand_mname_eng', 'b_grand_lname_eng', 'g_father_fname_eng', 'g_father_mname_eng', 'g_father_lname_eng', 'inf1_fname_eng', 'inf1_mname_eng', 'inf1_lname_eng', 'inf2_fname_eng', 'inf2_mname_eng', 'inf2_lname_eng'], 'string', 'max' => 40],
